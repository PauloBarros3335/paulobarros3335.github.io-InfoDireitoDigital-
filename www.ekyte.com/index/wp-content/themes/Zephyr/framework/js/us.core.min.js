...
(function($) {
    ...
    $us.PageScroller.prototype = {
        init: function(container, options) {
            ...
            $us.$window.on('resize load', this._events.resize);
            $us.$window.on('load', this._events.scroll);
            $us.$window.on('resize scroll', this._events.scroll);
        ...
        scrollTo: function(target) {
            var currentTime = new Date().getTime(),
                delay = 10;
            if (this.previousScrollTime !== undefined && (currentTime - this.previousScrollTime < this.options.animationDuration + delay)) {
                return
            }
            $us.$window.off('resize scroll', this._events.scroll);
        ...
        scroll: function() {
            var currentTime = new Date().getTime();
            if ((currentTime - this.previousScrollTime) < this.options.animationDuration) {
                return
            }
            ...
            this.scrollTimeout = setTimeout(function() {
                var scrollTop = parseInt($us.$window.scrollTop());
                if (scrollTop < this.sections[0].top) {
                    this.activeSection = 0
                } else if ((scrollTop + $us.$window.height()) >= this.sections[this.sections.length - 1].bottom) {
    ...
    $us.WTabs.prototype = {
        init: function(container, options) {
            ...
            setTimeout(function() {
                ...
                } else if (this.curLayout != 'accordion' || !this.isTogglable) {
        ...
        prepareLayout: function(to) {
            ...
            if (to == 'default' || to == 'timeline' || to == 'modern' || to == 'trendy') {
                ...
                this.$contents.hide();
                if (this.curLayout != 'accordion' && this.active[0] != undefined) {
