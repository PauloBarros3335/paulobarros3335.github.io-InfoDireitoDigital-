...
var FormFields = function() {
        ...
        function i(e) {
            ...
            if (t.length > 0) return t[0].name = "email", !0;
            var i = !1;
        ...
        function a(e) {
            var t = e.cloneNode(!0);
            return e.labels && e.labels.length > 0 && (t.name || (t.name = e.labels[0].innerText.trim())), "file" !== t.type && t.value !== e.node && (t.value = e.value), t
        }

        function u(e) {
            return !0 !== ["password", "submit", "button", "reset", "checkbox", "radio"].includes(e.type)
        }
        ...
        function l(e) {
            var t = [];
            return e.forEach(function(e) {
                if (!(!e.name || e.disabled || ["file", "reset", "submit", "button"].indexOf(e.type) > -1)) return "select-multiple" === e.type ? void Array.from(e.options).forEach(function(n) {
                    n.selected && t.push({
                        name: e.name,
                        value: n.value
                    })
                }) : void(["checkbox", "radio"].indexOf(e.type) > -1 && !e.checked || t.push({
                    name: e.name,
                    value: e.value
                }))
            }), t
    ...
    RDErrorNotifier = function() {
        function e(t, n) {
            _classCallCheck(this, e), this.requestStatus = t, this.requestBody = n
        }
...
var RDIntegrationCookieConsent = function() {
    ...
    var t = ["cookieconsent_status_ANALYTICS", "cookieconsent_status_ESSENTIAL", "cookieconsent_status_MARKETING", "cookieconsent_status_PERSONALIZATION", "cookieconsent_status_UNCATEGORIZED"],
        n = function(e) {
...
var RDIntegrationCreditCard = function() {
        function e(e) {
            ...
            for (; r--;) t = parseInt(n.charAt(r), 10) << i, o += t - 9 * (t > 9), i ^= 1;
            return o % 10 == 0 && o > 0
        }
    ...
    SensitiveDataFilter = function() {
        ...
        var r = ["captcha", "_wpcf7", "_wpnonce", "_viewstate", "_previouspage", "_viewstategenerator", "creditcard", "credit_card", "credit_number", "cardnumber", "cvv", "cvc", "securitycode", "pagseguro", "cielo", "pagarme", "billing", "erede_api", "cartao_credito", "cartaocredito", "cartão", "checkout", "rede_credit", "cardholder", "cartao_cartao"];
        return {
            filter: n
        }
    }();
...
var RDIntegrationDataPrivacy = function() {
    ...
    function n(e) {
        ...
        return Array.from(e.querySelectorAll('input[type="checkbox"][data-privacy]')).map(function(e) {
            ...
            e.value = Number(e.checked), t.push(e)
        }), t
    }
    return {
...
var FieldMapping = function() {
        ...
        function t(e) {
            var t, n, r = e.getAttribute("name") || e.name,
                o = /\[/g,
                i = /\]/g;
            return !!r && (t = r.replace(o, "_"), n = t.replace(i, ""), RDIntegrationDataPrivacy.isPrivacyCheckboxField(e) ? n : ["checkbox", "select-multiple"].indexOf(e.type) > -1 ? "".concat(n, "[]") : n)
        }
        ...
        function s(e) {
            a(Array.from(e.querySelectorAll("select[multiple] > option:checked")).map(function(e) {
                var t = e.cloneNode(!0);
                return t.name = e.parentNode.name, t.type = "select-multiple", t
            }))
        }

        function d(t) {
            return e(), u(t), c(t), l(t), f(t), s(t), m
        }
        var m = [];
        return {
            mapFields: d,
    ...
    RdIntegrationIdentifier = function() {
        ...
        function t(t) {
            var n, r = !1,
                o = ["squarespace.com", "realty_ajax_shortcode_contact_form"];
    ...
    RdIntegration = function() {
        var e, t, n, r, o, i = function(e, t, n) {
                a(e, t, n), u(), C()
            },
            a = function(e, o, i) {
                r = i || {}, t = e, n = o
            ...
            f = function(e) {
                var t = s(e);
                return t.push(o.identifier, o.token, h()), t
            },
            s = function(e) {
                return r.fieldMapping && (e = d(e)), e
            },
            d = function(e) {
            ...
            g = function() {
                var e = v("rdtrk");
                if (null !== e) return e = JSON.parse(unescape(e)), e.id
            },
            b = function(e) {
                var t = g();
            ...
            k = function(e, t, n) {
                var r, o;
                n = n || 3, r = 10 === n ? "form-integrations" : "conversions", e = b(e), e = _(e), e = A(e, n), e = RDIntegrationCookieConsent.insertCookieConsentData(e);
                var i = [];
                e.forEach(function(e, t) {
                    ...
                    if (e.status >= 500) return o = new RDErrorNotifier(e.status, i), void o.notify();
            ...
            w = function() {
                r = r || {}, console.info("Iniciando");
                var e = _getElementSubmit(),
                    t = l(e);
                0 === e.length ? console.warn("Nenhum botao de submit encontrado") : console.info("Botoes de submit encontrados: " + e.length), 0 === t.length ? console.warn("Nenhum formulario encontrado") : console.info("Formularios encontrados: " + t.length), F(t), console.info("Finalizado")
            },
            F = function(e) {
                o = y(), e.forEach(function(e, t) {
                    var n = f(e),
                        r = [];
                    console.info(t + 1 + " formulario"), FormFields.findEmail(e) ? console.info("Campo de email encontrado") : console.warn("Campo de email nao encontrado"), n.forEach(function(e, t) {
                        r.push(e.name)
                    }), console.info("Campos mapeados: " + r.join(", "))
                })
            },
            S = function(e, n) {
                r = n || {}, t = e, localStorage.getItem("RdIntegrationFormData") && q(), R()
            },
            R = function() {
