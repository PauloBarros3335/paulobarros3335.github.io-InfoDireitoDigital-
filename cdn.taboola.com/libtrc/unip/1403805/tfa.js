...
function(e, t) {
    e._tfa = e._tfa || [], e._tfa.config || (e._tfa.TfaConfig = function() {
    ...
    }, e._tfa.config = new e._tfa.TfaConfig, e._taboola = e._taboola || []), e._tfa.config.addConfig(1403805, {
        "tfa:event-host-map": {
        ...
        "tfa:tfa-codeless-tracking:advanced-matching-by-display-text": true,
...
function(e, t, n) {
    ...
    var u = null,
        ...
        A = [C, P],
        O = [I, _, w],
        N = (($ = {})[r.publisherIdType.NAME] = "name", $[r.publisherIdType.ID] = "id", $),
        U = function() {
            for (var e = {}, t = i.objKeys(n.networkMap), o = 0; o < t.length; ++o) {
                var a;
                e["" + n.networkMap[t[o]][N[r.publisherIdType.ID]]] = !0
            }
            return e
        }(),
        D = "gk",
        ...
        G, $, H = function t() {
            ...
            var u = function e() {};
            (u.prototype = Object.create(n.prototype)).constructor = u, u.prototype.providerName = "SourcePoint", u.prototype.isCookieBannerOfProvider = function() {
            ...
            var l = function e() {};
            return (l.prototype = Object.create(n.prototype)).constructor = l, l.prototype.providerName = "ConsentManager", l.prototype.isCookieBannerOfProvider = function() {
                return void 0 !== e.cmpmngr && "function" == typeof e.__cmp
            }, l.prototype.parseConsent = function() {
                ...
                var t = function e() {
                    r.trk.parseCookieBannerConsent(l.prototype)
                };
    ...
    var Z = {
            ...
            getBlockedState: function e(t) {
                return Re() || Pe() ? this.states.ABP_NOT_DETECTED : t && this.isBlockDetectedOnClassNames(t) ? this.states.ABP_DETECTED : this.states.ABP_NOT_DETECTED
            }
        },
        ee = function e(t, n) {
        ...
        ne = function t(n) {
            te(n), n[E] = C, n.isMediaRequest || (e.TRC.trkRequestStatus = !1), F === B.PENDING_USER_ID_SET && (F = B.UNINITIALIZED), n[y] ? r.eventUtils.dispatchEvent(r.sharedEvents.INVALID_TRK_RESPONSE, {
        ...
        le = function e() {
            r.eventUtils.dispatchEvent(L, x)
        },
        fe = function t(i, o) {
            if (e.clearTimeout(i[m]), o && o.trc) {
                if (o.trc.ui ? (o.trc["DNT"] && "TRUE" === o.trc["DNT"].toUpperCase() ? localStorage.removeItem("taboola global:user-id") : o.trc["cm"] || localStorage.setItem("taboola global:user-id", o.trc["ui"]), F = B.USER_ID_SET) : F = B.UNINITIALIZED, o.trc.sd && !o.trc["cm"] && localStorage.setItem(i.publisherId + ":session-data", o.trc["sd"]), o.trc["vl"] && o.trc["vl"].length) {
                    var a = o.trc["vl"][0].ri;
                    i.isMediaRequest || (e.TRC.events_ri = a), i[S] = a, i[E] = R, r.eventUtils.dispatchEvent(r.sharedEvents.REQUEST_ID_CREATED, {
            ...
            i[E] !== R && (i[E] = P, r.eventUtils.dispatchEvent(r.sharedEvents.REQUEST_ID_CREATION_ERROR, {
                publisherId: i.publisherId
            })), i.isMediaRequest || (e.TRC.trkRequestStatus = !(A.indexOf(i[E]) >= 0)), e.TRC.alertVVResponseLoaded && e.TRC.alertVVResponseLoaded(n.tblVersion), te(i), le()
        },
        de = function() {
            var e, t = function e() {
                    try {
        ...
        ge = function t() {
            ...
            var n = 400,
                r;
            return (G = e.location.search).length > n && (r = G.substring(0, n - 1), G = r.substring(0, r.lastIndexOf("&"))), G
        },
        ve = function e(t) {
            var n = Ee("usprivacy");
    ...
    var Se = function e(t) {
        ...
        Te = function e(t) {
            var n = be(t);
            return Re() && pe(n), t.isMediaRequest && (n = ye(t, n)), n
        },
        Ie = function e(t) {
        ...
        we = function e(t) {
            var r = null;
            return u || "" === u ? r = u : (l || "" === l) && (r = l), ("" === r || t.isMediaRequest) && (r = Ae("item-id", n.normalizeItemId, n.prenormalizeIdRules)), r
        },
        Ce = function e(t, n, r) {
            var o;
            if (!r) return n;
        ...
        Re = function e() {
            return ke(he(), "ampproject.net")
        },
        Pe = function e() {
            return ke(he(), "instantarticles.fb.com")
        },
        ke = function e(t, n) {
            try {
        ...
        Ae = function e(t, r, i) {
            ...
            return "item-url" === t && f === Oe ? h : (d = f !== De, h = "function" == typeof r ? r.call(this, h, u ? "video" : "text", d) : h)
        },
        Oe = function e(t, n) {
        ...
        Ve = function e() {
            return Ae("item-url", n.normalizeItemUrl, n.prenormalizeUrlRules)
        },
        je = function e(t) {
        ...
        $e = function e(t, n, r) {
            if (0 === i.objKeys(r).length || U["" + t]) return t;
            ...
            if (!u) {
                ...
                if (!u && a.indexOf("www.") < 0) {
                    for (p = 0, g = d.length; p < g && (m = new RegExp("(https://|http://|^)" + d[p] + "."), S = a.replace(m, "www."), !(u = Ge(r[S], c))); p++);
                    u || (u = Ge(r[S = "www." + a], c))
                }
            }
    ...
    e.TRC = e.TRC || {}, e.TRC.trk = r.trk = e.TRC.trk || {
        init: function t() {
            r.trk.parseCookieBanner(), e.TRC.utm && !Q() || (Q() || g || (e.TRC._getGlobalRequestId = _e, e.TRC._getItemId = we, e.TRC._getItemType = Me, g = !0), e.TRC.hasTrk ? Q() || r.trk.execute() : e._tfa && !e._tfa.config.hasValidConfig() || (r.hasTrk = !0, J() && (r.eventUtils.safeAddEventListener(r.sharedEvents.PAGE_VIEW, function(t) {
                try {
                    var i = t.detail,
                        o = i.publisherIdType,
                        a = i.accountId,
            ...
            }), Q() || r.trk.execute(), n.enableVV && Fe(), Q() && e._tfa.config.safeGet("tfa:trk:topics-enabled", !1, n.bakedPublisherId) && this.observeTopics())))
        },
        execute: function t() {
        ...
        hasRequestEnded: function e(t) {
            return He(t, function(e) {
                return A.indexOf(e) > -1 || !(O.indexOf(e) > -1)
            }, !1)
        },
        getPublisherRequestId: function e(t) {
            var n = ue(t);
            return n && n[E] === R ? n[S] : null
        },
        ...
        parseCookieBanner: function e() {
            var t, n;
            try {
                return (n = W()) ? n : null === (t = r.trk.parseCookieBannerProvider()) ? null : (r.trk.parseCookieBannerConsent(t), W())
            } catch (e) {
                return null
            }
        },
    ...
    }, Q() && !e._tfa.config.safeGet("tfa:trk:enabled", !0, n.bakedPublisherId) || r.trk.init()
}(window, document, {
    bakedPublisherId: 1403805,
    bakedPublisherName: 'taboolaaccount-marketingekytecom',
    tblVersion: "20250622-2-RELEASE",
...
function(e, t) {
    ...
    function w(e, t) {
        var n = _(e, t);
        n.est && (i.pageViewAccountIds ? C(i.pageViewAccountIds, n) : R(n))
    }
    ...
    function A(e) {
        (isNaN(y) || y < 0) && (y = 0), a.hasSessionEnded() || (y++, a.persistSpecificMetricsData(m, y), O() || o.sendMetrics("i", e), U())
    }
    ...
    function U() {
        if (clearTimeout(b), T && !d.getIsPageHidden()) {
            var e, t = r.config.safeGet("tfa:engagement:use-new-interval-calculation", !1) ? N(y) : p * Math.pow(2, y);
            t !== 1 / 0 && (b = setTimeout(A, t, t))
        }
    }
    ...
    function V(e) {
        ...
        M(), e && T && !d.getIsPageHidden() && t(e) && (T = !1, k(), j(g, v, D, k))
    }
    ...
    function B() {
        o.initialized || r.config.safeGet("tfa:engagement:is-manager-disabled", !1, 1403805) || (i = r.TUP || {}, o.initialized = !0, o.ESU.init(P), d.init(), h.init(a), L(), o.ESU.getIsLocalStorageAvailable() && (f.init(a), u.init(a, h, d), s.init(a, h), c.init(a, h, t.sharedEvents.PAGE_VIEW), l.init(a, h, f), o.initIntervalTrigger()), j(g, v, D, k))
    }
    o.init = o.init || B, o.onSessionEndTrigger = o.onSessionEndTrigger || P, o.sendMetrics = o.sendMetrics || w, o.initIntervalTrigger = o.initIntervalTrigger || D, o.EVENTS = o.EVENTS || E
}(window, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']),
function(e, t) {
    var n = "_tfa",
        r = e[n] = e[n] || [],
    ...
    t.lastExternalReferrer = {
        init: function e() {
            r.config.safeGet("tfa:last-external-referrer:is-disabled", !1, 1403805) || this.extractExternalReferrerIfExistsAndStoreLocally()
        },
...
function(e, t, n) {
    var r = "tfa:allow-codeless-tracking",
        i = "taboola-codeless-rules",
        o = "taboola-account-id",
        a = n.jsScope,
        s = n.publisherId;
    ...
    function u() {
        try {
            return !(!sessionStorage.getItem(i) && !sessionStorage.getItem(o))
        } catch (e) {
            return !1
        }
    }
    ...
    e.TRC = e.TRC || {}, e.TRC.codeless = a.codeless = e.TRC.codeless || {
        ...
        loadCodelessScript: function e() {
            var n = t.createElement("script"),
                r = "https://ads.realizeperformance.com/resources/static/js/codeless-events.js",
                i = (new Date).getTime();
...
function(e, t, n) {
    ...
    var i = "[TFA Codeless] ",
        o = "advancedMatching",
        a = "originalMatching",
        s = "tfa:tfa-codeless-tracking:advanced-matching",
        c = "tfa:allow-codeless-debug-events",
        u = "tfa:tfa-codeless-tracking:selector-matching-by-native-css";
        ...
        if (d) {
            ...
            e.TRC[h] = r[h] = e.TRC[h] || (_defineProperty(f = {
                ...
                handleClick: function e(t) {
                    ...
                    if (this.trackedElements && this.trackedElements.length) {
                        ...
                        if (!r || r.checkValidity()) {
                            var i = this.findMatchingTrackedElement({
                                clickedElement: n,
                            ...
                            if (i && i.eventNames && i.eventNames.length) {
                                var o = this;
                                i.eventNames.forEach(function(e) {
                                    o.pushEvent(e)
                                })
                            }
                        }
                ...
                isCodelessDebugEventsAllowed: function t() {
                    return e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(c, !1, d)
                },
                isAdvancedMatchingEnabled: function t() {
                    return e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(s, !1, d)
                },
                isSelectorMatchingByNativeCSSEnabled: function t() {
                    return e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(u, !1, d)
                },
                getFeatureFlag: function t(n, r) {
                    return e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(n, r || !1, d)
                }
            }, "isCodelessDebugEventsAllowed", function e() {
                return this.getFeatureFlag(c)
            }), _defineProperty(f, "isAdvancedMatchingEnabled", function e() {
                return this.getFeatureFlag(s)
            }), _defineProperty(f, "isSelectorMatchingByNativeCSSEnabled", function e() {
                return this.getFeatureFlag(u)
            }), _defineProperty(f, "findMatchingTrackedElement", function e(t) {
                var n = t.clickedElement,
                    r = this.getElementPath(n),
                    o = this.extractElementText(n),
                    a = this.extractHref(n),
                    s = t.sendCodelessDebugEvents,
                    c = t.publisherName,
                    u = t.isAdvancedMatchingEnabled,
                    l = t.isSelectorMatchingByNativeCSSEnabled;
                try {
                    var f;
                    return this.trackedElements.find(function(e) {
                        var t = this.isElementMatched({
                            ...
                            elementText: o,
                            elementHref: a,
                            isAdvancedMatchingEnabled: u,
                            isSelectorMatchingByNativeCSSEnabled: l
                        });
                        return t.isMatch && s && this.sendCodelessDebugEvent({
                            matchInfo: t,
                            publisherName: c
                        }), t.isMatch
                    }.bind(this))
                } catch (e) {
                    return __trcWarn(i + "Error matching tracked element:", e), null
                }
            }), _defineProperty(f, "isElementMatched", function e(t) {
                var n = t.clickedElement,
                    r = t.trackedElement,
                ...
                var f = this.isMatchedBySelector({
                    ...
                    d = this.isMatchedByDisplayText(r.displayText, s),
                    h = this.isMatchedByHref(r.href, c),
                    p;
                return p = u ? !!h || (r.selector ? f && d : d) : f || d, {
                    legacyElementPath: i,
                    elementText: s,
                    elementHref: c,
                    ...
                    isMatchedByDisplayText: d,
                    isMatchedByHref: h,
                    isMatch: p,
                    eventNames: r.eventNames,
                    matchingStrategy: u ? o : a
                }
            }), _defineProperty(f, "isMatchedBySelector", function e(t) {
                var n = t.clickedElement,
                    r = t.trackedSelector,
                    o = t.legacyElementPath,
                    a = t.isSelectorMatchingByNativeCSSEnabled;
                if (!r) return !1;
                var s = function e() {
                    return o.includes(r)
                };
                ...
                try {
                    ...
                    return __trcWarn(i + "Error matching by selector:", e), s()
                }
            }), _defineProperty(f, "findElementByPath", function e(n) {
                try {
                    return t.querySelector(n)
                } catch (e) {
                    return null
                }
            }), _defineProperty(f, "unescapeEmojis", function e(t) {
                return t ? t.replace(/\\u\{([0-9a-fA-F]+)\}/g, function(e, t) {
                    var n = parseInt(t, 16);
                    return String.fromCodePoint(n)
                }) : ""
            }), _defineProperty(f, "isMatchedByDisplayText", function e(t, n) {
                return !(!t || "string" != typeof t || "string" != typeof n) && this.unescapeEmojis(t).toLowerCase() === n.toLowerCase()
            }), _defineProperty(f, "isMatchedByHref", function e(t, n) {
                return !(!t || "string" != typeof t || void 0 === n || t.toLowerCase() !== n.toLowerCase())
            }), _defineProperty(f, "sendCodelessDebugEvent", function e(t) {
                var n = t.matchInfo,
                    r = t.publisherName,
                    i = new Date,
                    ...
                    s;
                a.searchParams.set("tim", o), a.searchParams.set("type", "CODELESS_TRACKING"), a.searchParams.set("msg", JSON.stringify(n)), (new Image).src = a.toString()
            }), _defineProperty(f, "pushEvent", function t(n) {
                try {
                    var r = d;
                    if (!r) return void __trcWarn(i + "Could not find valid publisher id");
                    r = parseInt(r, 10), e._tfa.push({
                        notify: "event",
                        name: n,
                        id: r
                    })
                } catch (e) {
                    __trcWarn(i + "Error pushing event:", e)
                }
            }), _defineProperty(f, "getElementPath", function e(n) {
                for (var r = [], i = n; i && i !== t;) {
    ...
    publisherName: 'taboolaaccount-marketingekytecom',
    publisherId: 1403805,
    jsScope: window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']
}),
function(e, t, n) {
    ...
    function g() {
        ...
        e.initialized && e.domAccountId && setTimeout(function() {
            for (var e = ie().asyncQueue; e.length;) oe(e.shift())
        }, 0)
    }
    ...
    function v() {
        var e = m(),
            t;
        if (e && e.src && (t = e.src.replace(c, "$3"))) return /^\d+$/.test(t) ? parseInt(t, 10) : (se("Value '" + t + "' is invalid for 'id' param in script source url '" + e.src + "'. Only numeric values are allowed."), INVALID_ACCOUNT_ID)
    }
    ...
    function T() {
        try {
            ...
            se("Error while trying to add user-id param", e)
        }
    }
    ...
    function I(e) {
        try {
            ...
            se("Error while trying to addClickIdParam, params=" + JSON.stringify(e), t)
        }
    }
    ...
    function w(e, t) {
        var n = EVENT_PROPERTIES_TO_URL_PARAMS_MAP.url,
            r;
        ve(le(e), t) && (e[n] = e[n] || document.location.href)
    }
    ...
    function P(e) {
        window.location.protocol.startsWith("https") && document.featurePolicy && document.featurePolicy.allowedFeatures() && -1 !== document.featurePolicy.allowedFeatures().indexOf("attribution-reporting") && (e.modifiers = e.modifiers || [], e.modifiers.push(k))
    }
    ...
    function U(e, n) {
        var r = fe(e) + l + de(e, n),
            i, o;
        H(n, e), M(n, e), P(n), (o = N(n)) && (i = O);
        try {
            t.TRCLogger[CONFIGS.httpMethod](r, CONFIGS.loggerEventName, n, e, i)
        } catch (t) {
            se("Error while trying to send to server event with id '" + e + "' and params '" + JSON.stringify(n) + "'.", t)
        }
    }
    ...
    function D(e) {
        ...
        if (n) {
            if (!t) return ce("No UserId to notify callback"), void delete e[CALLBACK_PARAMETER_NAME];
            if ("function" != typeof n) return ce("Callback function parameter is not a function " + n), void delete e[CALLBACK_PARAMETER_NAME];
            try {
                n({
                    userId: t
                })
            } catch (e) {
                se("Error calling advertiser callback", e)
            }
    ...
    function M(e, t) {
        b(e), I(e), _(e), Y(e), w(e, t), j(e), L(e), G(e, t), V(e, t), $(e, t), x(e)
    }
    ...
    function j(e) {
        e && a && a.ESU && a.ESU.getIsLocalStorageAvailable() && (B(e), F(e), K(e))
    }
    ...
    function X(e, n) {
        ...
        if (!t.trk.getPublisherRequestId(e)) {
            if (t.trk.isRequestProcessing(e)) return void r.messageDelayer.delayMessage(e, n, {
                ...
                timeoutInMillis: ue(e)
            });
            z(n, t.trk.getRequestStatus(e))
        }
        U(e, n)
    }
    ...
    function Z(e, n) {
        ...
        if (n = parseInt(n, 10), !o || !o(r, n)) {
            if (pe(n)) {
                if (ge(n)) return void X(n, r);
                t.trk.getPublisherRequestId(n) || z(r, "wffo")
            } else z(r, "ttd");
            U(n, r)
        }
    }
    ...
    function te(e, t) {
        var n = C(e);
        q(e, n), U(parseInt(t, 10), n)
    }

    function ne(e, n) {
        var r = ie(),
            i = !1;
        return n && (i = he(n), M(e), r.pageViewAccountIds[n] = parseInt(n, 10), t.eventUtils.dispatchEvent(t.sharedEvents.PAGE_VIEW, {
            accountId: n,
    ...
    function oe(e) {
        var t, n;
        if (re(e))
            if (t = ie(), n = e.id || t.domAccountId) {
                if (n !== INVALID_ACCOUNT_ID) try {
                    s[e.notify](e, n)
                } catch (t) {
                    se("An error occurred while handling command '" + JSON.stringify(e) + "'.", t)
                }
    ...
    function he(e) {
        return pe(e) && o.config.safeGet("tfa:trk:is-unified-page-view", !1, e)
    }
    ...
    }, TUP_EVENT_HANDLERS_BY_EVENT_NAME = ((p = {})["page_view"] = ne, p), TRK_EVENT_TO_ERROR_TYPE_MAP = function() {
        var e = {};
    ...
    }(), PUBLISHER_ID_EXISTS = !isNaN(parseFloat(1403805)), CALLBACK_PARAMETER_NAME = "callback", LAST_EXTERNAL_REFERRER_URL_PARAM = "ler", me()
}(window, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC'], "20250622-2-RELEASE"),
function(e, t, n) {
    var r = "_tfa",
        i, o = {
            orderid: "orderid",
    ...
    function S() {
        var t, n, r, i;
        if (r = e._tfa.config.safeGet("tfa:get-publisher-id-from-baker", !1) && p ? 1403805 : C())
            for (t = 0, n = l.length; t < n; t++) b(y(s, {
                $publishreId: r ? r + "/" : "",
                $logType: "action"
            }) + "tim=" + escape(I()) + "&item-url=" + escape(T()) + R(o, l.shift()) + _() + v() + m())
    }
    ...
    function E() {
        ...
        if (r = e._tfa.config.safeGet("tfa:get-publisher-id-from-baker", !1) && p ? 1403805 : C())
            for (t = 0, n = f.length; t < n; t++) b(y(s, {
                $publishreId: r ? r + "/" : "",
                $logType: "mark"
            }) + "tim=" + escape(I()) + "&item-url=" + escape(T()) + R(a, f.shift()) + _() + v() + m())
    }
    ...
    function O() {
        (i = e[r] = e[r] || []).registered || (i.push = P, i.registered = !0, A())
    }
    O()
}(window, document, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']);